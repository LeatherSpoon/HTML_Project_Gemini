...
export const CODEX_ENTRIES = [
  ...
  { id: 'orosil',      category: 'Material', label: 'Orosil',      flavor: 'A rare gold-silver alloy found in deep mineral seams. Prized by traders and artificers alike.' },
  { id: 'gold',        category: 'Material', label: 'Gold',        flavor: 'Dense precious metal. High conductivity, higher value.' },
  { id: 'fractalite',  category: 'Material', label: 'Fractalite',  flavor: 'A crystalline compound with recursive internal geometry. Radiates faint energy.' },
  { id: 'stahlerte',   category: 'Material', label: 'Stahlerte',   flavor: 'Hardened alloy of extreme density. Used in structural and armored applications.' },
  ...
  { id: 'aetherite',   category: 'Material', label: 'Aetherite',   flavor: 'Compressed energy in crystalline form. Handle with caution near circuitry.' },
  { id: 'magnet',      category: 'Material', label: 'Magnet',      flavor: 'A permanent magnetic element. Useful in motors and traps.' },
  { id: 'glass',       category: 'Material', label: 'Glass',       flavor: 'Smelted silicate. Brittle but optically pure.' },
  { id: 'holzura',     category: 'Material', label: 'Holzura',     flavor: 'Dense hardwood composite. Rigid, heat-cured, and remarkably durable.' },
  { id: 'verdanite',   category: 'Material', label: 'Verdanite',   flavor: 'Living mineral-plant matter. Grows slowly and stores organic energy.' },
  { id: 'logicite',    category: 'Material', label: 'Logicite',    flavor: 'Salvaged micro-logic substrate. Forms the neural fabric of complex machines.' },
  { id: 'piedral',     category: 'Material', label: 'Piedral',     flavor: 'Compressed stone shards dropped by mineral-shelled creatures. Dense and jagged.' },
  { id: 'knochel',     category: 'Material', label: 'Knochel',     flavor: 'Hardened organic matter from defeated enemies. Part bone, part hide.' },
  { id: 'bronzura',    category: 'Material', label: 'Bronzura',    flavor: 'A bronze-derived alloy with faint radioactive properties. Dangerous in quantity.' },
  { id: 'basalva',     category: 'Material', label: 'Basalva',     flavor: 'Raw basaltic mineral from volcanic deposits. Extremely heat-resistant.' },
  { id: 'tobarba',     category: 'Material', label: 'Tobarba',     flavor: 'Porous volcanic rock laced with metallic ore veins. Found near lava flows.' },
  { id: 'vitrion',     category: 'Material', label: 'Vitrion',     flavor: 'Refined glass-silicon composite. Near-perfect for optical and computing systems.' },
  // Enemies
