...
const INV_ICONS = {
  ...
  stone:     { bg:'#3a3a3a', border:'#888888', label:'Sn', r:'2px' },
  ...
  orosil:    { bg:'#1a1800', border:'#ddbb44', label:'Os', r:'50%' },
  gold:      { bg:'#502e00', border:'#ddaa00', label:'Au', r:'50%' },
  fractalite:{ bg:'#0a0a28', border:'#7733ee', label:'Fr', r:'2px' },
  stahlerte: { bg:'#1a1e22', border:'#8899aa', label:'St', r:'2px' },
  resin:     { bg:'#3a1a00', border:'#aa6622', label:'Rn', r:'50% 50% 0 50%' },
  verdanite: { bg:'#051505', border:'#33bb55', label:'Vd', r:'50%' },
  epoxy:     { bg:'#1a2230', border:'#445577', label:'Ep', r:'2px' },
  aetherite: { bg:'#120020', border:'#cc22ff', label:'Ae', r:'50%' },
  magnet:    { bg:'#280a14', border:'#aa3355', label:'Mg', r:'2px' },
  glass:     { bg:'#0a2a38', border:'#66aacc', label:'Gl', r:'2px' },
  holzura:   { bg:'#1a0e06', border:'#8a5a30', label:'Hz', r:'2px' },
  // Combat drop materials
  logicite:  { bg:'#001a18', border:'#00ddcc', label:'Lc', r:'2px' },
  piedral:   { bg:'#181410', border:'#887766', label:'Pd', r:'2px' },
  knochel:   { bg:'#1a1810', border:'#ccbbaa', label:'Kn', r:'50%' },
  bronzura:  { bg:'#1a0e00', border:'#cc8833', label:'Bz', r:'2px' },
  // Factory Raw
  basalva:   { bg:'#1a0806', border:'#cc3311', label:'Ba', r:'2px' },
  tobarba:   { bg:'#140808', border:'#884422', label:'Tb', r:'2px' },
  // Factory Refined
  vitrion:   { bg:'#001a1a', border:'#44ddee', label:'Vi', r:'4px' },
  // Factory Artifacts
