const RECIPES = {
  ...
  neuralCoil: {
    ...
    materials: { logicite: 2, copper: 2, quartz: 1 },
    baseTime: 10,
    minCraftingLevel: 3,
  },
  spikeKnuckles: {
  ...
  overchargeCell: {
    ...
    type: 'consumable',
    key: 'overchargeCell',
    materials: { aetherite: 1, copper: 2 },
    baseTime: 8,
    minCraftingLevel: 3,
  },
  heavyPlateArmor: {
  ...
  pulseModule: {
    ...
    materials: { fractalite: 2, silica: 1 },
    baseTime: 12,
    minCraftingLevel: 4,
  },
  dataCache: {
  ...
  ironHelm: {
    ...
    tier: 'Basic',
    statBonuses: { defense: 2 },
    materials: { iron: 4, stone: 2 },
    baseTime: 10,
    minCraftingLevel: 2,
  },
  aetheriteVisor: {
    label: 'Aetherite Visor',
    type: 'equipment',
    slot: 'head',
    tier: 'Combat',
    statBonuses: { focusRate: 3, perception: 1 },
    materials: { aetherite: 2, glass: 2, vitrion: 1 },
    baseTime: 16,
    minCraftingLevel: 4,
  },
  // ── Legs slot ──────────────────────────────────────────────────────────────
  fiberGreaves: {
    ...
    slot: 'legs',
    tier: 'Basic',
    statBonuses: { agility: 1, health: 1 },
    materials: { fiber: 4, iron: 2 },
    baseTime: 10,
    minCraftingLevel: 2,
  },
  tobarbaGreaves: {
    label: 'Tobarba Greaves',
    type: 'equipment',
    slot: 'legs',
    tier: 'Combat',
    statBonuses: { defense: 3, agility: 2 },
    materials: { tobarba: 2, iron: 3 },
    baseTime: 16,
    minCraftingLevel: 4,
  },
  // ── Shoulders slot (deploy1) ───────────────────────────────────────────────
  stoneSpaulders: {
    label: 'Stone Spaulders',
    type: 'equipment',
    slot: 'deploy1',
    tier: 'Basic',
    statBonuses: { defense: 2 },
    materials: { stone: 4, fiber: 2 },
    baseTime: 10,
    minCraftingLevel: 2,
  },
  bronzuraSpaulders: {
    label: 'Bronzura Spaulders',
    type: 'equipment',
    slot: 'deploy1',
    tier: 'Combat',
    statBonuses: { defense: 4, health: 1 },
    materials: { bronzura: 2, stone: 2 },
    baseTime: 16,
    minCraftingLevel: 4,
  },
  // ── Boots slot (deploy2) ───────────────────────────────────────────────────
  copperBoots: {
    ...
    slot: 'deploy2',
    tier: 'Basic',
    statBonuses: { agility: 1, gatherSpeed: 1 },
    materials: { copper: 4, fiber: 2 },
    baseTime: 8,
    minCraftingLevel: 2,
  },
  holzuraBoots: {
    ...
    slot: 'deploy2',
    tier: 'Combat',
    statBonuses: { agility: 2, gatherSpeed: 1 },
    materials: { holzura: 2, fiber: 3 },
    baseTime: 14,
    minCraftingLevel: 4,
  },
  // ── Rare tier — require Assembly Matrix outputs ────────────────────────────
  hullPlateChest: {
    label: 'Hull Plate Chest',
    type: 'equipment',
    slot: 'body',
    tier: 'Rare',
    statBonuses: { defense: 8, health: 3 },
    materials: { hull_segment: 1, stahlerte: 2, bronzura: 1 },
    baseTime: 25,
    minCraftingLevel: 5,
  },
  circuitCoil: {
    ...
    slot: 'accessory',
    tier: 'Rare',
    statBonuses: { focusRate: 4, perception: 2 },
    materials: { circuit_board: 1, aetherite: 2, vitrion: 1 },
    baseTime: 22,
    minCraftingLevel: 5,
  },
};
